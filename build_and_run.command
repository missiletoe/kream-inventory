...
# 1️⃣ Python 3.11 버전이 설치되어 있는지 확인
if ! command -v python3.11 &>/dev/null; then
    echo "[INFO] Python 3.11이 설치되지 않았습니다. 자동 설치 진행..."
...
PYTHON_VER=$(python3.11 -c "import sys; print('python{}.{}'.format(sys.version_info.major, sys.version_info.minor))")
